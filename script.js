...
(function() {
    setTimeout(function() {
        console.log("%c* STOP COPY SOURCE !", "color: red; font-size: 45px; font-weight: bold; text-shadow: 2px 2px 5px black;");
        console.log("%c⇝ © HOÀNG VĂN BẢO ✅", "color: black; font-size: 40px; font-weight: bold;");
